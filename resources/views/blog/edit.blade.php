            ...
            <div class="mb-3 row g-3">
              ...
              <div class="col-xl-5 col-sm-9">
                <div class="input-group  @error('thumbnail') is-invalid border-danger @enderror">
                  <input type="file" class="dropify " name="thumbnail" data-default-file="{{ asset('storage/blogs/' . $blog->thumbnail) }}" data-show-remove="false" data-allowed-file-extensions="png jpg jpeg" data-max-file-size="1M" value="{{ $blog->thumbnail_content }}" />
                  @error('thumbnail')
